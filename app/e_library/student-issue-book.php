                                    ...
                                    if (isset($_POST["submit2"])) {
                                      ...
                                      $res= mysqli_query($link, "select * from add_book where books_name='$_POST[booksname]'");
                                       ...
                                       if ($qty==0) {
                                          ...
                                          mysqli_query($link, "insert into issue_book values('''$_SESSION[regno]','$_POST[name]','$_POST[sem]','$_POST[session]','$_POST[phone]','$_POST[mail]','$_POST[booksname]','$_POST[booksissuedate]','$_POST[booksreturndate]','$_SESSION[susername]') ");
