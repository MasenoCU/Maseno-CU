                ...
                <form action="" class="form-inline" method="post">
					...
					<?php if(isset($error_pw)):?> 
                     <span class="error"> <?php echo $error_pw; ?></span>
                      <?php endif ?>
                    <div class="form-group">
                         <label for="lecturer">Designation <span>*</span></label>
                        <input type="text" class="form-control custom" placeholder="Librarian" name="lecturer"/>
                    </div>
                    <div class="form-group">
                    ...
                    <span class="error"><?php echo $error_id; ?></span>
                      <?php endif ?>
                    <div class="form-group">
                         <label for="address">Residence / Hostels<span>*</span></label>
