...
<body>
			...
			<div class="reg-body">
				...
				<?php endif ?>
                    ...
                    <span class="error"><?php echo $error_phone; ?></span>
                      <?php endif ?>
                    <div class="form-group">
					    <label for="sem">Select Year Semester <span>*</span></label>
                    ...
                    <div class="form-group">
                    	 <label for="session">Course of Study <span>*</span></label>
                        <input type="text" class="form-control custom" placeholder="BSc Acturial Science with IT" name="session"/>
                    </div>
                    <div class="form-group">
                    ...
                    <span class="error"><?php echo $error_reg; ?></span>
                      <?php endif ?>
                    <div class="form-group">
                    	 <label for="address">Residence Area / Hostel <span>*</span></label>
                        <textarea name="address" id="address"  class="form-control custom" placeholder="Equator Hostels"></textarea>
                            </div>
                            </div>
		</div>
	</div>
    ...
    <div class="footer text-center">
        <p>&copy; All rights reserved Maseno University Christian Union</p>
    </div>
