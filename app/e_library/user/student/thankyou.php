...
<body>
    <div class="thankyou-content text-center">
		...
		<h4 style="margin-top: 80px;">If you have not received an email then your account  does not exist <br> Please register with gmail account</h4>
		<p><a href="registration.php" style="text-decoration: underline; font-weight: bold; font-size: 20px">Register Again</a></p>
        <p><a href="login.php" style="text-decoration: underline; font-weight: bold; font-size: 20px">Proceed to login</a></p>
    </div>
