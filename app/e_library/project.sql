...
(17, 'teacher', '1001', 'Nahid Hossen', 'CSE', '01721455456', 'nahid001@gmail.com', 'Theoretical Numerical Analysis', '03/04/2024', '04/05/2024', 'nahid22');
...
ALTER TABLE t_issuebook 
ADD COLUMN return_status ENUM('pending', 'returned') DEFAULT 'pending',
