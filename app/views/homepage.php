            ...
            <header class="p-3 mb-3 border-bottom">
                <div class="container-xl">
                    <div class="d-flex flex-wrap align-items-center justify-content-center">
                        <!-- navbar brand -->
                        <a href="/" class="link-body-emphasis text-decoration-none mb-2 mb-md-0">
                            <svg width="40" height="32" xlmns="http://www.w3.org/2000/svg">
                                <rect width="100%" height="100%" fill="white" />
                                <svg class="bi me-2" width="40" height="32" aria-label="MUCU Logo">
                        ...
                        <!-- online giving -->
                        <button type="button"
                            class="btn disabled btn-sm btn-success rounded-pill mb-2 mb-md-0 me-md-2 me-xl-auto mx-auto mx-sm-0">
                        ...
                        <!-- search -->
                        <form class="col-auto mb-2 mb-md-0 mx-2 me-xl-auto mx-auto mx-sm-2 ms-lg-1" role="search">
                            <input type="search" class="form-control" placeholder="Search..." aria-label="Search">
                        </form>
                        <!-- member profile -->
                        <div class="dropdown text-end mb-2 mb-md-0 mx-auto mx-sm-0">
                            <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="assets/images/Preston.jpeg" alt="member" width="32" height="32"
                            ...
                            <ul class="dropdown-menu text-small">
                                ...
                                <li><a href="logout.php" class="logout-btn dropdown-item">Sign out</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
