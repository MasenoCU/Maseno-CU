                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-day"  value="<?php  echo $data['day']; ?>" type="text" placeholder="Enter Day"  required="" name="day"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-date"  value="<?php  echo $data['date']; ?>" type="number" placeholder="Enter Date" step="1"  required="" name="date"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="month_of_year">Month Of Year <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-month_of_year"  value="<?php  echo $data['month_of_year']; ?>" type="text" placeholder="Enter Month Of Year"  required="" name="month_of_year"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
