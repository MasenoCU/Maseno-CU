                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-date"  value="<?php  echo $this->set_field_value('date',""); ?>" type="number" placeholder="Enter Date" step="1"  required="" name="date"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-month_of_year"  value="<?php  echo $this->set_field_value('month_of_year',""); ?>" type="text" placeholder="Enter Month Of Year"  required="" name="month_of_year"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
