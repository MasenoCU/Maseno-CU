...
<body style="background: url('Frontend Assets/Images/light_christian_bg.jp');">
    <!-- spinner -->
    <!-- SVG icons -->
            ...
            <nav class="p-0 mb-1 mt-xl-2 mx-xl-auto border rounded navbar-expand-sm bg-primary" data-bs-theme="auto">
                <div class="collapse navbar-collapse">                        
                    <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                        <li class="nav-item"><a href="index.html" class="nav-link px-2 link-secondary active" aria-current="page">Home</a></li>
                        <li class="nav-item"><a href="#" class="nav-link px-2 link-body-emphasis">About Us</a></li>
              ...
              <div class="row justify-content-center">
                <div class="col-6 col-md-2 mb-3 text-center">
                  ...
                  <ul class="nav nav-pills nav-fill flex-column">
                    <li class="nav-item mb-2"><a href="index.html" class="active nav-link p-0 text-body-secondary">Home</a></li>
                ...
                <div class="col-6 col-md-2 mb-3">
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a class="nav-link p-0" href="https://www.facebook.com/Masenocu/" target="_blank"><svg class="bi text-body-primary" width="20" height="20"><use xlink:href="icons.svg#facebook"></use></svg> Facebook</a></li>
                    <li class="nav-item mb-2"><a class="nav-link p-0" href="https://whatsapp.com/channel/0029VaCqwFSIt5ryXrSNeN3w" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="icons.svg#whatsapp"></use></svg> WhatsApp</a></li>
                    <li class="nav-item mb-2"><a class="nav-link p-0" href="http://www.youtube.com/@maseno_cu" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="icons.svg#youtube"></use></svg> YouTube</a></li>
                    <li class="nav-item mb-2"><a class="nav-link p-0" href="https://www.instagram.com/maseno_cu/" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="icons.svg#instagram"></use></svg> Instagram</a></li>
                    <li class="nav-item mb-2"><a class="nav-link p-0" href="https://twitter.com/Maseno_CU" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="icons.svg#twitter-x"></use></svg> X</a></li>
                  </ul>
                </div>
