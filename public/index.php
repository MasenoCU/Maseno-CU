                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>
                                ...
                                <div class="mobile-s d-sm-none display-6 text-muted">Maseno University Christian Union!
                                </div>
                                <div class="content-to-hide-xs mobile-m d-md-none display-5 text-muted">Maseno
                                    University Christian Union!</div>
                                <div class="d-none d-md-block display-2 text-muted">Maseno University Christian Union!
                                </div>
                            </h1>
                            <p class="lead mt-2 mb-1 text-muted">We are a group of committed young men and women living
                                for God and pursuing a holy life.</p>
                            <p class="lead mt-0 text-muted">Join us in our journey of faith.</p>
                            <p><a class="btn btn-md btn-outline-success border-2" href="about.php" id="learnmore">Learn
                                    more</a></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-md-6 text-center text-md-start">
                ...
                <p class="my-2 text-muted">Since its inception in 1978, the Maseno University Christian Union has
                    experienced remarkable growth, becoming a vibrant community of believers dedicated to living for God
                    and pursuing a holy life. With a rich history and a strong
                    foundation in discipleship, the Christian Union continues to impact lives and maintain stability in
                    Christian faith.</p>
                <a href="about.php" class="btn btn-outline-success btn-md ms-auto mb-2 border-2">Learn More</a>
            </div>
    ...
    <div class="container-xl">
        <div class="row justify-content-center align-items-center">
            ...
            <p class="my-4 lead text-muted text-center">
                At Maseno University Christian Union, our core values revolve around living for God and pursuing a holy
                life.
            </p>
    ...
    <div class="container-xl ">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-md-7 text-center text-md-start order-md-2">
                ...
                <p class="my-2 text-muted ">Joining the Maseno University Christian Union offers a unique opportunity to
                    experience spiritual growth and find support within a vibrant community of like- minded individuals.
                    Through engaging in various ministries and evangelistic teams, you will have the chance to deepen
                ...
                <div class="card border-0 h-100">
                    ...
                    <div class="card-footer">
                        ...
                        <p class="mb-0 d-inline"><a class="icon-link icon-link-hover"
                                style="--bs-link-hover-color-rgb: 0, 166, 81;" href="blogs.php#hgtml">
                                Read more
            ...
            <div class="col">
                <div class="card border-0 h-100">
                    ...
                    <div class="card-footer">
                        ...
                        <p class="mb-0 d-inline"><a class="icon-link icon-link-hover"
                                style="--bs-link-hover-color-rgb: 0, 166, 81;" href="blogs.php#ofad">
                                Read more
                                <svg class="bi" aria-hidden="true">
                                    <use xlink:href="assets/icons.svg#arrow-bar-right"></use>
                                </svg>
            ...
            <div class="col">
                <div class="card border-0 h-100">
                    ...
                    <div class="card-body p-2">
                        ...
                        <p class="card-text text-muted">This is a wider card with supporting text below as a natural
                            lead-in to additional content. This card has even longer content than the first to show that
...
<section id="FAQs">
    <div class="container-xl">
        <div class="text-start">
            ...
            <p class="lead text-muted">Find answers to frequently asked questions about the Maseno University Christian
    ...
    <div class="container-xl md-4 align-content-center align-items-center">
        <div class="p-2 text-center bg-body-tertiar rounded-3 home-cta">
            ...
            <div class="d-inline-block text-center text-md-start">
                ...
                <a href="#login" id="learnmore" class="btn btn-outline-primary btn-md ms-1 border-1 rounded-pill">Sign
                    in</a>
            </div>
        </div>
    </div>
        ...
        <div class="row row-cols-1 row-cols-lg-2 justify-content-center align-items-center align-content-center">
            <div class="col-auto col-lg-4">
                <div class="text-start">
                    ...
                    <p><small><a href="mailto:contact@yourcu.com" class="contact-link">contact@yourcu.com</a></small>
                    </p>
                </div>
                <div class="text-start">
                    <h5>Phone</h5>
