    ...
    <div class="container-xl">
        <div class="row">
            <div class="col col-auto col-md-6">
                <h2 class="display-6">A Journey of Faith: The History and Growth of Maseno University Christian Union
                </h2>
            </div>
            <div class="col col-auto col-md-6">
                <p class="text-muted">Maseno University Christian Union, established in 1978 as an affiliate of Moi
                    University, has experienced remarkable growth over the years. From its humble beginnings, the Union
                    has grown in population, with a large number of converts joining every year. As a community of
                    committed young men and women, the Christian Union provides discipleship care to new converts and
    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-md-6 order-md-1">
                <h2>
                    <div class="display-6">Commited to <span class="text-body-secondary">Discipleship, Evangelism</span>
                        and <span class="text-body-secondary">Fostering a Strong Christian Community</span>
                    </div>
                </h2>
                <p class="text-muted">At Maseno University Christian Union, we are dedicated to nurturing disciples,
                    spreading the Gospel, and building a vibrant Christian community.</p>
                <ul>
                    <li>Discipleship is at the core of our mission, guiding believers in their spiritual growth.</li>
    ...
    <div class="container-xl">
        <div class="row align-items-center">
            <div class="col-lg-6 order-md-2">
                ...
                <p class="text-muted">At Maseno University Christian Union, we are guided by a set of core beliefs and
                ...
                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim
...
<section id="membership">
    <div class="container-xl">
        <div class="row mb-4">
            ...
            <div class="col col-auto col-md-6">
                <p class="text-muted">At Maseno University Christian Union, we offer different membership options to
                    cater to the diverse needs of our community. Whether you're looking for full membership or associate
                    membership, we have a place for you. As a member, you have certain rights and responsibilities that
        ...
        <div class="row">
            <div class="col-auto col-md-6 col-lg-3">
                <h5>Full Member</h5>
                <p class="text-muted">Full membership provides access to all the benefits and privileges of being a
                    member of Maseno University Christian Union.</p>
            </div>
            <div class="col-auto col-md-6 col-lg-3">
                <h5>Associates</h5>
                <p class="text-muted">Associate membership is available for individuals who want to be part of our
                    community without full commitment.</p>
            </div>
            <div class="col-auto col-md-6 col-lg-3">
                <h5>Renewal of Membership</h5>
                <p class="text-muted">To renew your membership, simply follow the renewal process outlined on our
                    website.</p>
            </div>
            <div class="col-auto col-md-6 col-lg-3">
                <h5>Cessation of Membership</h5>
                <p class="text-muted">If you wish to cease your membership, please contact our membership department for
                    assistance.</p>
            </div>
        </div>
</section>
