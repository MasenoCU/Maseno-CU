...
<head>
    ...
    <!-- page title -->
    <title>Maseno University Christian Union Leadership</title>
  ...
  <div class="container-xl">
      ...
      <div class="row text-center">
          ...
          <div class="col-md-4 col-lg-3">
            <img src="assets/images/Paul Mwika.jpg" class="rounded-circle" width="100" height="100" aria-label="leader-image" preserveAspectRatio="xMidYMid slice" focusable="false">
            <h5 class="fw-bold mt-2">Paul Mwika</h5>
            <h5 class="mb-3">Chairperson</h5>
            <p class="mb-2 text-muted">Paul is a passionate leader who is commited to serving God and guiding our Union.</p>
            <ul class="nav justify-content-center mb-4">
              <li class="nav-item mx-1"><a class="nav-link p-0" href="https://linkedin.com/in/paul-mwika-2066b8234" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#linkedin"></use></svg></a></li>
              <li class="nav-item mx-1"><a class="nav-link p-0" href="https://facebook.com/paul.mwika.52" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#facebook"></use></svg></a></li>
              <li class="nav-item mx-1"><a class="nav-link p-0" href="https://wa.me/qr/JPJ4MZ3SNEHDD1" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#whatsapp"></use></svg></a></li>
            </ul>
          </div>
          <!-- vice chairperson -->
          <div class="col-md-4 col-lg-3">
            <img src="assets/images/student_m.png" class="rounded-circle" width="100" height="100" aria-label="leader-image" preserveAspectRatio="xMidYMid slice" focusable="false">
              <h5 class="fw-bold mt-2">Lenox Mutwiri</h5>
              <h5 class="mb-3">Vice Chairperson</h5>
              <p class="mb-2 text-muted">Lenox brings his strong faith and organizational skills to support the growth of our Union.</p>
              <ul class="nav justify-content-center mb-4">
                <li class="nav-item mx-1"><a class="nav-link p-0" href="#" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#linkedin"></use></svg></a></li>
                <li class="nav-item mx-1"><a class="nav-link p-0" href="https://facebook.com/" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#facebook"></use></svg></a></li>
                <li class="nav-item mx-1"><a class="nav-link p-0" href="#" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#whatsapp"></use></svg></a></li>
              </ul>
          </div>
          <!-- secretary -->
          <div class="col-md-4 col-lg-3">
            <img src="assets/images/student_f.png" class="rounded-circle" width="100" height="100" aria-label="leader-image" preserveAspectRatio="xMidYMid slice" focusable="false">
          ...
          <div class="col-md-4 col-lg-3">
            <img src="assets/images/student_m.png" class="rounded-circle" width="100" height="100" aria-label="leader-image" preserveAspectRatio="xMidYMid slice" focusable="false">
              ...
              <p class="mb-2 text-muted">Kevin manages the financial resources of our Union with integrity and transparency.</p>
              <ul class="nav justify-content-center mb-4">
                <li class="nav-item mx-1"><a class="nav-link p-0" href="#" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#linkedin"></use></svg></a></li>
                <li class="nav-item mx-1"><a class="nav-link p-0" href="https://facebook.com/" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#facebook"></use></svg></a></li>
                <li class="nav-item mx-1"><a class="nav-link p-0" href="#" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#whatsapp"></use></svg></a></li>
          ...
          <div class="col-md-4 col-lg-3">
            <img src="assets/images/student_f.png" class="rounded-circle" width="100" height="100" aria-label="leader-image" preserveAspectRatio="xMidYMid slice" focusable="false">
              ...
              <p class="mb-2 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, voluptatum.</p>
              <ul class="nav justify-content-center mb-4">
                <li class="nav-item mx-1"><a class="nav-link p-0" href="#" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#linkedin"></use></svg></a></li>
                <li class="nav-item mx-1"><a class="nav-link p-0" href="https://facebook.com/" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#facebook"></use></svg></a></li>
                <li class="nav-item mx-1"><a class="nav-link p-0" href="#" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#whatsapp"></use></svg></a></li>
            ...
            <div class="col-md-4 col-lg-3">
              <img src="assets/images/student_m.png" class="rounded-circle" width="100" height="100" aria-label="leader-image" preserveAspectRatio="xMidYMid slice" focusable="false">
                ...
                <p class="mb-2 text-muted">Fidel organizes impactful outreach programs to spread the love of Christ to others.</p>
                <ul class="nav justify-content-center mb-4">
                  <li class="nav-item mx-1"><a class="nav-link p-0" href="#" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#linkedin"></use></svg></a></li>
                  <li class="nav-item mx-1"><a class="nav-link p-0" href="https://facebook.com/" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#facebook"></use></svg></a></li>
                  <li class="nav-item mx-1"><a class="nav-link p-0" href="#" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#whatsapp"></use></svg></a></li>
          ...
          <div class="col-md-4 col-lg-3">
            <img src="assets/images/student_f.png" class="rounded-circle" width="100" height="100" aria-label="leader-image" preserveAspectRatio="xMidYMid slice" focusable="false">
              ...
              <p class="mb-2 text-muted">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellat, reiciendis!</p>
              <ul class="nav justify-content-center mb-4">
                <li class="nav-item mx-1"><a class="nav-link p-0" href="#" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#linkedin"></use></svg></a></li>
                <li class="nav-item mx-1"><a class="nav-link p-0" href="https://facebook.com/" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#facebook"></use></svg></a></li>
                <li class="nav-item mx-1"><a class="nav-link p-0" href="#" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#whatsapp"></use></svg></a></li>
            ...
            <div class="col-md-4 col-lg-3">
              <img src="assets/images/student_m.png" class="rounded-circle" width="100" height="100" aria-label="leader-image" preserveAspectRatio="xMidYMid slice" focusable="false">
                ...
                <p class="mb-2 text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, reprehenderit!</p>
                <ul class="nav justify-content-center mb-4">
                  <li class="nav-item mx-1"><a class="nav-link p-0" href="#" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#linkedin"></use></svg></a></li>
                  <li class="nav-item mx-1"><a class="nav-link p-0" href="https://facebook.com/" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#facebook"></use></svg></a></li>
                  <li class="nav-item mx-1"><a class="nav-link p-0" href="#" target="_blank"><svg class="bi text-body-secondary" width="20" height="20"><use xlink:href="assets/icons.svg#whatsapp"></use></svg></a></li>
      ...
      <div class="row justify-content-center align-items-center">              
        <a href="leadership.php" class="btn col-auto btn-success btn-sm mt-3">Meet them all</a>
      </div>
  </div>
</section>
