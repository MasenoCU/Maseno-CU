                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-ministry"> Ministry</th>
                                                <th  class="td-year_of_study"> Year Of Study</th>
                                                <th  class="td-eve_team"> Eve Team</th>
                                                <th  class="td-school_id_path"> School Id Path</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
