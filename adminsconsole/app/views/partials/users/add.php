                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-admission_number"  value="<?php  echo $this->set_field_value('admission_number',""); ?>" type="text" placeholder="Enter Admission Number"  required="" name="admission_number"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-ministry"  value="<?php  echo $this->set_field_value('ministry',""); ?>" type="text" placeholder="Enter Ministry"  required="" name="ministry"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-year_of_study"  value="<?php  echo $this->set_field_value('year_of_study',""); ?>" type="number" placeholder="Enter Year Of Study" step="1"  required="" name="year_of_study"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-eve_team"  value="<?php  echo $this->set_field_value('eve_team',""); ?>" type="text" placeholder="Enter Eve Team"  required="" name="eve_team"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <input id="ctrl-school_id_path"  value="<?php  echo $this->set_field_value('school_id_path',""); ?>" type="text" placeholder="Enter School Id Path"  required="" name="school_id_path"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
