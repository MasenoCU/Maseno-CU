...
class UsersController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				users.email LIKE ? OR 
				users.course LIKE ? OR 
				users.admission_number LIKE ? OR 
				users.phone_number LIKE ? OR 
				users.ministry LIKE ? OR 
				users.year_of_study LIKE ? OR 
				users.eve_team LIKE ? OR 
				users.school_id_path LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("username","password","email","course","admission_number","phone_number","ministry","year_of_study","eve_team","school_id_path");
			...
			$this->sanitize_array = array(
				...
				'ministry' => 'sanitize_string',
				'year_of_study' => 'sanitize_string',
				'eve_team' => 'sanitize_string',
				'school_id_path' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","username","password","email","course","admission_number","phone_number","ministry","year_of_study","eve_team","school_id_path");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$cpassword = $postdata['confirm_password'];
			$password = $postdata['password'];
